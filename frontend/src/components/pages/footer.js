              ...
              <div className="footer-thumb">
                ...
                <div className="contact-info" id="contact-info">
                  ...
                  <p>
                    ...
                    <a href="#contact-info">info@company.com</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 col-sm-4">
              <div className="footer-thumb">
                ...
                <ul className="social-icon" id="social-icon">
                  ...
                  <li>
                    <a className="fa" href="#social-icon">
            ...
            <div className="col-md-12 col-sm-12 border-top">
              <div className="col-md-4 col-sm-6">
                <div className="copyright-text">
                  <p>
                    Copyright &copy; 2017 divineion | Design:{" "}
                    <a href="http://www.tooplate.com" target="_parent">
                      Tooplate
                    </a>
                  </p>
                </div>
